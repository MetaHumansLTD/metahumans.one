    ...
    if ($isPhp && !$isAuthPath && !$isIndex) {
        ...
        if (!isset($_SESSION['mh_auth_user'])) {
            if ($isAjaxRequest || (isset($_SERVER['HTTP_ACCEPT']) && strpos($_SERVER['HTTP_ACCEPT'], 'application/json') !== false)) {
                ...
                $escapedRedir = htmlspecialchars($redir, ENT_QUOTES, 'UTF-8');
                if (!headers_sent()) {
                    header('Location: ' . $redir, true, 302);
                    header('Content-Type: text/html; charset=UTF-8', true);
                }
                $html = '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta http-equiv="refresh" content="0; url=' . $escapedRedir . '"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Sign in required</title></head><body style="font-family:system-ui,sans-serif;background:#020617;color:#e2e8f0;margin:0;padding:32px;"><p>Please <a style="color:#60a5fa;" href="' . $escapedRedir . '">sign in</a> to continue.</p></body></html>';
