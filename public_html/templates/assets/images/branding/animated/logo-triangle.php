<?php
// Meta Humans - Animated Triangle Logo (PHP Version)
...
<head>
    ...
    <title>Meta Humans - Animated Triangle Logo</title>
    <style>
        body {
        ...
        .meta-humans-triangle-logo:active {
        ...
        .meta-humans-triangle-logo:hover .triangle-logo-image {
        ...
        /* Additional pseudo-element for extra glow */
        .meta-humans-triangle-logo::after {
            content: '';
            position: absolute;
            top: -15px;
            left: -15px;
        ...
        .meta-humans-triangle-logo:hover::after {
            opacity: 1;
        }
    </style>
</head>
<body>
    <div class="logo-container">
        ...
        <div class="logo-version">Triangle Logo Version</div>
