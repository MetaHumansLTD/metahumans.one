(function() {
    ...
    if (!document.getElementById('large-header') || !document.getElementById('demo-canvas')) {
        console.warn('Demo-3: Required elements not found, skipping animation');
        return;
    }
    ...
    try {
        ...
        console.error('Demo-3 animation error:', e);
    }
    ...
    function initHeader() {
        ...
        if (!largeHeader) {
            console.warn('Demo-3: large-header element not found, skipping animation');
            return false;
        }
        ...
        if (!canvas) {
            console.warn('Demo-3: demo-canvas element not found, skipping animation');
            return false;
        }
        canvas.width = width;
