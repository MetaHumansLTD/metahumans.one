    ...
    private function netearthoneEffectiveConfig(): array
    {
        ...
        $envResolved = [
            ...
            'ip_address' => $this->firstEnvString([
                ...
                'NETEARTHONE_WHITELIST_IPS',
                'NETEARTHONE_ALLOWED_IPS',
                'NETEARTHONE_ALLOWED_IP',
                'NETEARTHONE_ACL_IP',
                'NETEARTHONE_ACL_IPS',
                'NETEARTHONE_OUTBOUND_IP',
                'NETEARTHONE_OUTBOUND_IPS',
                'NETEARTHONE_EGRESS_IP',
                'NETEARTHONE_EGRESS_IPS',
                'NETEARTHONE_CLIENT_IPS',
                'NEO_IP_ADDRESS',
                'NEO_IP',
                'NEO_WHITELIST_IP',
                'NEO_WHITELIST_IPS',
