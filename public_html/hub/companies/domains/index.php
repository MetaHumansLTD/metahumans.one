...
if (ob_get_level() === 0) {
    ...
    define('MH_HUB_COMPANIES_DOMAINS_OB_CLEANUP', true);
}
...
if (!is_file($cueBootstrapPath)) {
    ...
    if (defined('MH_HUB_COMPANIES_DOMAINS_OB_CLEANUP')) {
        @ob_end_clean();
    }
    if (!headers_sent()) {
    ...
    echo "CUE bootstrap path is not available for hub companies domains dispatch.\n";
    exit;
}
